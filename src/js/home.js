Vue.component("home",{
    ...
    template: `
        <b-jumbotron class="mt-2" >
            ...
            <p>
            We would like your feedback. For any issues or comments you have with or about this site please contact us via email at <br/><h4><a href="mailto:OPESPD@publications.europa.eu">OPESPD@publications.europa.eu</a></h4> or <a href="https://github.com/OP-TED/espd-demo/issues">open a ticket on GitHub</a>. Feel free to download or use any parts of the code of this site from our <a href="https://github.com/OP-TED/espd-demo">GitHub repository</a>. The code is distributed under the <a href="https://github.com/OP-TED/espd-demo/blob/main/LICENCE">EUROPEAN UNION PUBLIC LICENCE v. 1.2</a>.</p>
